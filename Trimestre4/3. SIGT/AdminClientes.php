...
<body>
    ...
    <div class="d-flex flex-column flex-md-row">
        ...
        <div class="sidebar collapse d-md-block p-3" id="sidebarMenu">
            ...
            <ul class="nav flex-column text-center">
                ...
                <li class="nav-item">
                    <a href="AdminClientes.php" class="nav-link custom-link active">Clientes</a>
                </li>

                <hr class="bg-light">

                <li class="nav-item">
                    <a href="AdministrarClientes.php" class="nav-link custom-link">Administrar Clientes</a>
                </li>
                <li class="nav-item">
                    <a href="#" class="nav-link custom-link" data-bs-toggle="modal"
                        data-bs-target="#modalReporteCliente">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer d-flex justify-content-center">
                        <a href="index.php" class="btn custom-btn">Aceptar</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <main class="flex-grow-1 p-4 bg-light">
                ...
                <div class="col-12">
                    <div class="card shadow-sm">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="btn-group">
                                <button class="btn btn-success btn-sm" id="btnAgregarCliente" title="Crear">
                            ...
                            <table class="table table-bordered align-middle text-center">
                                ...
                                <tbody id="tablaInventario">
                                    <tr id="cliente-1">
                                        ...
                                        <td>12</td>
                                        <td>
                                            <button class="btn btn-sm btn-warning btn-editar" data-id="cliente-1"><i
                                                    class="bi bi-pencil"></i></button>
                                            <button class="btn btn-sm btn-danger btn-eliminar" data-id="cliente-1"><i
                                    ...
                                    <tr id="cliente-2">
                                        ...
                                        <td>4</td>
                                        <td>
                                            <button class="btn btn-sm btn-warning btn-editar" data-id="cliente-2"><i
                                                    class="bi bi-pencil"></i></button>
                                            <button class="btn btn-sm btn-danger btn-eliminar" data-id="cliente-2"><i
                                                    class="bi bi-trash"></i></button>
                                        </td>
                                    </tr>
                                    <tr id="cliente-3">
                                        ...
                                        <td>7</td>
                                        <td>
                                            <button class="btn btn-sm btn-warning btn-editar" data-id="cliente-3"><i
                                                    class="bi bi-pencil"></i></button>
                                            <button class="btn btn-sm btn-danger btn-eliminar" data-id="cliente-3"><i
                                                    class="bi bi-trash"></i></button>
                                        </td>
                                    </tr>
                                </tbody>
            ...
            <div class="row g-4 align-items-stretch text-center">
                ...
                <div class="col-12 col-md-4 d-flex">
                    <div class="card shadow-sm w-100 d-flex flex-column">
                        ...
                        <div class="card-body d-flex justify-content-center align-items-center">
                            <canvas id="graficoClientes" style="max-height: 250px; max-width: 250px;"></canvas>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4 d-flex">
                    <div class="card shadow-sm w-100 d-flex flex-column">
                        <div class="card-header fw-bold bg-info text-white">Top 5 cientes con más compras</div>
                        <div class="card-body">
                            <ol class="list-group list-group-numbered" id="listaTopClientes">
                                <!-- Se llena con JS -->
                            </ol>
                        </div>
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="formProducto">
                    <div class="modal-header text-black">
                        <h5 class="modal-title" id="clienteModalLabel">Agregar Prodctos</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="productosAdquiridos" required>
                            </div>
                        </div>
                        <div class="modal-footer d-flex justify-content-center">
    ...
    <div class="modal fade" id="modalEliminar" tabindex="-1" aria-labelledby="modalEliminarLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    Esta acción no se puede deshacer<br>¿Deseas eliminar este cliente?
                </div>
    ...
    <div class="modal fade" id="modalReporteCliente" tabindex="-1" aria-labelledby="modalReporteClienteLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content shadow">
                <div class="modal-header text-black">
                    <h5 class="modal-title" id="modalReporteClienteLabel">Generar Reporte de Empleados</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
    ...
    <script src="js/9. administrarclientes.js"></script>
